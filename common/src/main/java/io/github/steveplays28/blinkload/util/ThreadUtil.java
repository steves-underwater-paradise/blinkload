...
public class ThreadUtil {
	private static final @NotNull Executor ATLAS_TEXTURE_IO_THREAD_POOL_EXECUTOR = Executors.newFixedThreadPool(
			1, new ThreadFactoryBuilder().setNameFormat(String.format("%s Atlas Texture Cache I/O", BlinkLoad.MOD_NAME)).build());
	...
	public static @NotNull Executor getAtlasTextureIOThreadPoolExecutor() {
		return ATLAS_TEXTURE_IO_THREAD_POOL_EXECUTOR;
	}
